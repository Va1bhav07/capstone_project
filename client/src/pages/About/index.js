    ...
    <div className="about-us-container">
      <div className="about-us-content">
        ...
        <p>
          ...
          hendrerit libero vitae dui fermentum, ac euismod nulla tempor.
          Vestibulum venenatis justo vel tincidunt sagittis. In hac habitasse
          platea dictumst. Suspendisse potenti.
        </p>
        <p>
          Phasellus vitae luctus nunc. Nulla facilisi. Sed tincidunt, dolor eu
          dapibus consectetur, nisi elit bibendum lectus, non facilisis purus
          quam non metus.
        </p>
        <p>
          Our platform is dedicated to providing high-quality education,
          accessible to everyone. Whether you are a student, professional, or
          just curious to learn new things, we have a diverse range of courses
          to suit your needs.
        </p>
        <p>
        ...
        <div className="about-us-section">
          <h3>Our Team</h3>
          <p>
            Meet the passionate individuals driving our learning platform
            forward.
          </p>
        </div>
